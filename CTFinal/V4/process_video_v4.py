...
def process_video_v4(video_path, output_dir):
    ...
    output_video_path = os.path.join(output_dir, f"{name}_v4.avi")
    print(f"Processing video V4: {video_path} -> {output_video_path}")
    ...
    while cap.isOpened():
        ...
        processed_frame = process_frame_v4(frame)
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(base_dir, "1", "results_v4")):
        os.makedirs(os.path.join(base_dir, "1", "results_v4"))
    if not os.path.exists(os.path.join(base_dir, "2", "results_v4")):
        os.makedirs(os.path.join(base_dir, "2", "results_v4"))

    videos1 = glob.glob(os.path.join(base_dir, "1", "*.avi"))
    for vid in videos1:
        process_video_v4(vid, os.path.join(base_dir, "1", "results_v4"))

    videos2 = glob.glob(os.path.join(base_dir, "2", "*.avi"))
    for vid in videos2:
        process_video_v4(vid, os.path.join(base_dir, "2", "results_v4"))
