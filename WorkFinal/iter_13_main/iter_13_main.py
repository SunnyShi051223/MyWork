...
def main():
    ...
    Config.FEATURE_METHOD = 'causal_shap_consensus' 
    Config.ENABLE_FEATURE_ENGINEERING = False 
    Config.ENABLE_WGAN_AUGMENTATION = True 
    Config.setup()
    
    print(f"\n=== Iteration 13 Started: The Supreme Paradigm (Causal-SHAP Consensus + WGAN Rounding + Stacking) ===")
    print(f"!!! STRICT NESTED CV ENABLED: Testing the ultimate mathematical limits of the algorithm !!!")
    ...
    iter_folder_name = f"iter_13_supreme_consensus_gan_strict_cv_{Config.TIMESTAMP}"
