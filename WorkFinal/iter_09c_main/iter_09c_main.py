...
def main():
    ...
    Config.FEATURE_METHOD = 'hierarchical_group' 
    Config.ENABLE_FEATURE_ENGINEERING = False
    Config.setup()
    
    print(f"\n=== Iteration 9c Started: Hierarchical Tree-Guided Group Selection (STRICT CV) ===")
    ...
    iter_folder_name = f"iter_09c_hierarchical_{Config.TIMESTAMP}"
    backup_iteration(iter_folder_name)
    
    print(f"\n=== Iteration 9c Completed ===")
