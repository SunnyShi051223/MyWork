...
def main():
    # Force parameters for Iteration 2
    # Moving from XGBoost to Logistic Regression for high Recall and interpretability
    Config.MODEL_TYPE = 'logistic'
    Config.FEATURE_METHOD = 'stability' 
    Config.setup()
    
    print(f"\n=== Iteration 2 Started: Logistic Regression + Stability Selection ===")
    ...
    iter_folder_name = f"iter_02_logistic_stability_{Config.TIMESTAMP}"
