...
def main():
    ...
    print(f"\n=== Iteration 10d Started: Multi-Task Learning (STRICT CV) ===")
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(X, y)):
        ...
        print(f"       Fold {fold + 1}: Training MTL (Multi-Task Learner) completely isolated on {len(X_train)} training samples...")
    ...
    with open(Config.GLOBAL_LOG_PATH, mode='a', newline='', encoding='utf-8') as f:
        ...
        writer.writerow([
            Config.TIMESTAMP, "mtl_strict_cv",
    ...
    iter_folder_name = f"iter_10d_mtl_strict_cv_{Config.TIMESTAMP}"
    backup_iteration(iter_folder_name, metrics)
    print(f"\n=== Iteration 10d Completed ===")
