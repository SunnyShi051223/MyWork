...
def main():
    ...
    Config.FEATURE_METHOD = 'markov_blanket' 
    Config.ENABLE_FEATURE_ENGINEERING = False
    Config.setup()
    
    print(f"\n=== Iteration 9b Started: Causal Markov Blanket Approximation (STRICT CV) ===")
    ...
    iter_folder_name = f"iter_09b_markov_blanket_{Config.TIMESTAMP}"
    backup_iteration(iter_folder_name)
    
    print(f"\n=== Iteration 9b Completed ===")
