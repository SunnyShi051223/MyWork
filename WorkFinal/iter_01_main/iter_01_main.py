...
def main():
    # Force parameters for Iteration 1
    Config.MODEL_TYPE = 'xgboost'
    # We will modify feature_selection.py to accept a 'method' parameter default to 'hybrid'
    Config.FEATURE_METHOD = 'hybrid' 
    Config.setup()
    
    print(f"\n=== Iteration 1 Started: XGBoost + Hybrid (Lasso/RF) Selector ===")
    ...
    iter_folder_name = f"iter_01_xgb_l1_hybrid_{Config.TIMESTAMP}"
